...
const stats = [
  { k: "Mission workflow", v: "Natural language -> structured plan", note: "Scenario workflow" },
  { k: "Safety gates", v: "7 pre-execution checks", note: "Constraint validation" },
  { k: "Operator approval", v: "Required", note: "Human-in-the-loop enforced" },
  {
    k: "Autonomous execution",
    v: "Disabled by design",
    note: "No physical execution without approval",
  },
];
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-20 pb-24">
          ...
          <p className="mt-4 max-w-2xl text-muted-foreground text-lg">
            Turn natural-language field instructions into safe, structured, operator-approved robot
            missions.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              ...
              className="rounded-md bg-primary px-5 py-3 font-semibold text-primary-foreground glow-primary hover:brightness-110 transition"
            >
              Generate Mission
            </Link>
            <Link
          ...
          <div className="mt-14 grid gap-4 lg:grid-cols-3">
            <Panel className="lg:col-span-2">
              <div className="flex items-center justify-between">
                <div className="hud-label">Mission Console / PoC scenario</div>
                <div className="flex items-center gap-1.5 hud-label">
                  <StatusDot tone="ok" /> scenario-ready
                </div>
              </div>
        ...
        <div className="grid gap-4 md:grid-cols-4">
          {stats.map((s) => (
            <Panel key={s.k}>
              ...
              <div className="mt-2 font-display text-xl font-semibold text-primary">{s.v}</div>
          ...
          {[
            {
              ...
              d: "Operators describe field goals in plain language. NOVA FieldOps extracts task type, target, constraints, and priorities.",
            },
            {
              t: "Safety-gated planning",
              d: "Every mission is checked against restricted zones, weather, terrain, battery, and missing-data risks before approval.",
            },
            {
              t: "Structured export",
              d: "Missions are exported as clean, machine-readable JSON for integration-ready NOVA OS or partner-stack workflows.",
            },
          ].map((c, i) => (
            <Panel key={c.t}>
          ...
          <div className="mt-2 grid gap-4 md:grid-cols-3">
            <div>
              ...
              <div className="text-sm text-muted-foreground">
                Missions never execute without explicit human sign-off.
              </div>
            </div>
            <div>
              <div className="font-semibold">No autonomous physical execution</div>
              <div className="text-sm text-muted-foreground">
                NOVA FieldOps plans and validates. Robots act only after approval.
              </div>
            </div>
            <div>
              <div className="font-semibold">Civil agriculture only</div>
              <div className="text-sm text-muted-foreground">
                Scoped to farming, monitoring, and infrastructure inspection.
              </div>
            </div>
          </div>
        </Panel>
